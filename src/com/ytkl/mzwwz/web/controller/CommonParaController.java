...
@Controller
public class CommonParaController {
	private static final Logger log = LoggerFactory.getLogger(CommonParaController.class);
	...
	@RequestMapping("/commonPara/list.do")
	...
	@RequestMapping("/commonPara/detail.do")
	...
	@RequestMapping("/commonPara/write.do")
	...
	@RequestMapping("/commonPara/edit.do")
	...
	@RequestMapping("/commonPara/save.do")
	public @ResponseBody
	String save(@Valid CommonPara commonPara, BindingResult result, ModelMap model) {
		if (result.hasErrors()) {
	...
	@ActionControllerLog(channel = "commonPara", action = "update.do", title = "修改", isSaveRequestData = true)
	@RequestMapping("/commonPara/update.do")
	public @ResponseBody
	String update(@Valid CommonPara commonPara, BindingResult result, CommonParaCriteria commonParaCriteria,
			ModelMap model) {
		if (result.hasErrors()) {
			return ValidatorShow.create().showErrors(result, model);
		}
		...
		commonPara.setModifier(loginUser.getUserid());
	...
	@RequestMapping("/commonPara/delete.do")
	public @ResponseBody
	String delete(String code, CommonParaCriteria commonParaCriteria, ModelMap model) {

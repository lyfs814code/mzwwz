...
@Controller
public class ParaDepartController {
	private static final Logger log = LoggerFactory.getLogger(ParaDepartController.class);

	@Autowired
	private CommonParaService commonParaService;

	@RequestMapping("/paraDepart/list.do")
	...
	@RequestMapping("/paraDepart/detail.do")
	...
	@RequestMapping("/paraDepart/write.do")
	...
	@RequestMapping("/paraDepart/edit.do")
	...
	@RequestMapping("/paraDepart/save.do")
	...
	@RequestMapping("/paraDepart/update.do")
	...
	@RequestMapping("/paraDepart/delete.do")

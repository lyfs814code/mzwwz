...
@Controller
public class ParaLeaderController {
	private static final Logger log = LoggerFactory.getLogger(ParaLeaderController.class);

	@Autowired
	private CommonParaService commonParaService;

	@RequestMapping("/paraLeader/list.do")
	...
	@RequestMapping("/paraLeader/detail.do")
	...
	@RequestMapping("/paraLeader/write.do")
	...
	@RequestMapping("/paraLeader/edit.do")
	...
	@RequestMapping("/paraLeader/save.do")
	...
	@RequestMapping("/paraLeader/update.do")
	...
	@RequestMapping("/paraLeader/delete.do")
